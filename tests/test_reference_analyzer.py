...
SAMPLE_CHAPTER_1 = """宝玉走进潇湘馆，只见凤尾森森，龙吟细细。

\u201c妹妹可大好了？\u201d宝玉问道。
黛玉抿嘴一笑，\u201c哪里就好了，不过是强撑着罢了。\u201d
宝玉叹道：\u201c你总是这样，何苦来哉。\u201d

两人对坐无言，只听得窗外竹声飒飒。"""

SAMPLE_CHAPTER_2 = """话说贾母在堂上坐定，众媳妇丫鬟簇拥而来。

\u201c今日是什么日子，怎么都来了？\u201d贾母笑道。
凤姐忙上前说：\u201c老祖宗，今儿是端阳佳节，大家来给老太太请安。\u201d
贾母点头道：\u201c难为你们想着。\u201d

于是摆下酒宴，众人依次入座。宝玉黛玉同在一桌，湘云宝钗紧挨着坐了。"""
...
class TestStructureAnalysis:
    ...
    def _mock_chapters(self):
        ...
        return [
            {"id": "ch1", "title": "第一回", "versions": [
                {"id": "v1", "content": SAMPLE_CHAPTER_1, "title": "第一回"}
            ], "current_version": "v1"},
            {"id": "ch2", "title": "第二回", "versions": [
                {"id": "v2", "content": SAMPLE_CHAPTER_2, "title": "第二回"}
            ], "current_version": "v2"},
        ]
...
class TestCaching:
    ...
    def test_analysis_saved_and_loaded(self, tmp_path):
        ...
        mock_chapters = [
            {"id": "ch1", "title": "测试", "versions": [
                {"id": "v1", "content": "这是测试内容。", "title": "测试"}
            ], "current_version": "v1"},
        ]
