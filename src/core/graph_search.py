...
Inspired by MiroFish's InsightForge: decomposes user questions into sub-questions,
generates Cypher queries, executes them, and synthesizes results.

Unlike MiroFish which uses Zep Cloud embeddings, this implementation uses:
