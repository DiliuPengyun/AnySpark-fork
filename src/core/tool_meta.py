...
WRITE_TOOLS = {"extract_knowledge", "store_chapter", "write_chapter", "store_inspiration",
               "decompose_chapter", "rewrite_by_chain",
               "delete_chapter", "delete_all_chapters", "import_chapters",
               "edit_chapter", "revert_chapter", "extract_all_chapters",
               "extract_chapter",
               "prepare_writing", "finalize_chapter",
               "delete_version", "purge_chapter_history",
               "transform_book", "find_replace_book", "summarize_book",
               ...
               "manage_volumes", "generate_volume_outlines",
               "manage_workflows", "manage_workflow_steps", "execute_workflow",
               "add_material", "subscribe_material", "unsubscribe_material",
               "delete_material",
               "manage_skills", "agent_tasks"}

READ_TOOLS = {"search_knowledge", "list_chapters", "read_chapter", "read_document",
              "ask_user", "chapter_history", "diff_chapters", "get_outline",
...
EDIT_TOOLS = {"decompose_chapter", "annotate_chain", "rewrite_by_chain", "read_chapter", "search_knowledge", "extract_style", "reconstruct_chapter", "compare_plot"}
...
ANALYSIS_TOOLS = {"search_knowledge", "list_chapters", "read_chapter", "read_document",
                  ...
                  "analyze_structure", "quantify_style",
                  "list_pending_foreshadows", "plan_foreshadow", "schedule_foreshadow", "postpone_foreshadow"}
...
TOOL_META: dict[str, dict[str, bool]] = {
    ...
    "manage_workflows":      {"streaming": True},
    ...
    # Whole-book transform tools (chapter_tools.py)
